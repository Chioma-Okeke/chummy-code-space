            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                        ...
                                        <div>
                                            ...
                                            {exp.achievements.length > 2 && (
                                                <button
                                                    ...
                                                    className="mt-3 text-purple-600 hover:text-purple-700 text-sm font-medium flex items-center transition-colors duration-200"
                                                >
                                                    {expandedExp === exp.id ? (
                                                        <>
                                                            Show Less
                ...
                <div className="mt-16 grid md:grid-cols-4 gap-6">
                    <Card className="p-6 text-center bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                        <h4 className="text-3xl font-bold text-purple-700 mb-2">4+</h4>
                    ...
                    <Card className="p-6 text-center bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                        <h4 className="text-3xl font-bold text-green-700 mb-2">15+</h4>
