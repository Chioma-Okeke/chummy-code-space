                        ...
                        <Card key={volunteer.id} className="mb-8 overflow-hidden border-0 shadow-2xl bg-gradient-to-br from-white to-purple-50">
                            <div className="grid lg:grid-cols-2 gap-0">
                                ...
                                <div className="relative h-64 lg:h-auto">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-purple-900/30 via-purple-600/20 to-transparent"></div>
                                ...
                                <div className="p-8 lg:p-12 space-y-6">
                                    ...
                                    {/* Call to Action */}
                                    <div className="pt-4">
                                        <Link target='_blank' href={"https://shecodeafrica.org/"} className="flex items-center w-fit bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-purple-200 transition-all duration-300">
