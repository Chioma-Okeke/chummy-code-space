                        ...
                        <div className="flex items-center mb-4 md:mb-0">
                            ...
                            <div>
                                ...
                                <p className="text-purple-100">
                                    I write about React concepts, cybersecurity practices, and full-stack development insights on {profileData.blog.platform}
                                </p>
                            </div>
                        </div>
                        <Button
                            variant="outline"
                            className="bg-white/10 border-white/30 text-white hover:bg-white/20 px-6 py-2 rounded-full backdrop-blur-sm"
                        >
                            Visit My Blog
                            ...
                            >
                                ...
                                <div className="p-6 space-y-4">
                                    ...
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                        className="w-full text-purple-600 hover:text-purple-700 hover:bg-purple-50 transition-colors duration-300 mt-4"
                                    >
                                        Read Article
                                        <ExternalLink className="w-4 h-4 ml-2" />
                                    </Button>
