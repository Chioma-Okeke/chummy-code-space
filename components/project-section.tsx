                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
                        {profileData.projects.map((project) => (
                            <Card
                                key={project.id}
                                className={`group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 ${hoveredProject === project.id ? 'ring ring-purple-400' : ''
                                    }`}
                                ...
                                <div className="relative overflow-hidden h-48">
                                    ...
                                    <div className="max-lg:hidden absolute bottom-4 left-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">
                                        {project.demoUrl && <Link
                                            ...
                                            target='_blank'
                                            className="flex-1 bg-white/90 hover:bg-white text-gray-900 backdrop-blur-sm flex items-center rounded-lg justify-center"
                                        >
                                        ...
                                        {project.githubUrl && <Link
                                            ...
                                            target='_blank'
                                            className="flex-1 bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm flex items-center rounded-lg justify-center"
                                        >
